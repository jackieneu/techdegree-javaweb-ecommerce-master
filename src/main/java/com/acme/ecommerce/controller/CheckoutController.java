...
public class CheckoutController {
	...
	String postCouponCode(Model model, @ModelAttribute(value="couponCode") @Valid CouponCode couponCode, final BindingResult result, RedirectAttributes redirectAttributes) {
		if(result.hasErrors()) {
